 ...
 * @author Andreas Nölke <https://github.com/zeromax>
 */
var AjaxRequest =
{
	/**
	...
	toggleFileManager: function (el, id, folder, level) {
		...
		if (item) {
			if (image.hasClass('fa-plus-square-o')) {
				item.setStyle('display', 'inline');
				image.removeClass('fa-plus-square-o');
				image.addClass('fa-minus-square-o');
				...
				image.addClass('fa-plus-square-o');
				image.removeClass('fa-minus-square-o');
